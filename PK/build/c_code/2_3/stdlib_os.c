...
STRING_LITERAL(TMP31, "unknown OS error", 16);
...
N_NIMCALL(void, raiseoserror_115809)(NI32 errorcode) {
	...
	asgnRefNoCycle((void**) (&(*e).Sup.Sup.message), oserrormsg_115620(errorcode));
	{
		...
		LOC5 = 0;
		LOC5 = (*e).Sup.Sup.message; (*e).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP31));
...
N_NOINLINE(void, nosraiseOSError)(NimStringDesc* msg) {
	{
		...
		LA7: ;
		{
			NimStringDesc* LOC11;
			LOC11 = 0;
			LOC11 = (*e_115416).Sup.Sup.message; (*e_115416).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP31));
