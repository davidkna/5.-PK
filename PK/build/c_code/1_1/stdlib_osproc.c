...
N_NIMCALL(NCSTRING, buildenv_144906)(Stringtableobj135012* env);
...
N_NIMCALL(NCSTRING, buildenv_144906)(Stringtableobj135012* env) {
	...
	L = ((NI) 0);
	{
		...
		val_144912 = 0;
		{
			...
			h_144939 = 0;
			HEX3Atmp_144941 = 0;
			HEX3Atmp_144941 = ((*env).data ? ((*env).data->Sup.len-1) : -1);
			res_144943 = ((NI) 0);
			{
				while (1) {
					...
					h_144939 = res_144943;
					{
						...
						L += (NI)((NI)((key_144911 ? key_144911->Sup.len : 0) + (val_144912 ? val_144912->Sup.len : 0)) + ((NI) 2));
					}
					LA7: ;
					res_144943 += ((NI) 1);
				} LA4: ;
	...
	L = ((NI) 0);
	{
		...
		val_144923 = 0;
		{
			...
			h_144951 = 0;
			HEX3Atmp_144953 = 0;
			HEX3Atmp_144953 = ((*env).data ? ((*env).data->Sup.len-1) : -1);
			res_144955 = ((NI) 0);
			{
				while (1) {
