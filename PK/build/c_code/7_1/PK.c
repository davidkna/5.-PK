...
typedef N_NOCONV_PTR(int, TY109444) (NCSTRING x1, int x2);
struct  Tcell46347  {
NI refcount;
TNimType* typ;
};
...
NIM_EXTERNC N_NOINLINE(void, PKInit)(void) {
	{
		...
		LOC4 = 0;
		LOC4 = glob(HEX3Atmp_146006->data, ((int) 0), ((TY109444) (NIM_NIL)), (&f_146010));
		res_146012 = ((NI) (LOC4));
		{
	...
	LA15: ;
	{
		...
		res_146058 = ((NI) 1);
		{
			while (1) {
				...
				LOC21 = 0;
				LOC21 = noschangeFileExt(((NimStringDesc*) &TMP50), ((NimStringDesc*) &TMP51));
				LOC22 = 0;
				LOC22 = HEX2F_118292(LOC20, LOC21);
				memset((void*)LOC23, 0, sizeof(LOC23));
				LOC24 = 0;
				LOC24 = nospstartProcess(LOC22, ((NimStringDesc*) &TMP51), LOC23, 0, NIM_NIL, 8);
				nossleep(((NI) 500));
				res_146058 += ((NI) 1);
			} LA19: ;
		}
