...
STRING_LITERAL(TMP142, "almostReverseKeysIS.csv", 23);
STRING_LITERAL(TMP143, "testData/almostReverseKeysIS.csv.lock", 37);
STRING_LITERAL(TMP144, "testData/almostReverseKeysIS.csv", 32);
