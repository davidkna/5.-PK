...
typedef NIM_CHAR TY98670[6];
typedef NIM_CHAR TY98673[2501];
typedef NIM_CHAR TY98665[3];
...
NIM_CONST TY98665 floatformattochar_98664 = {103,
102,
101}
;
...
N_NIMCALL(NimStringDesc*, nsuformatBiggestFloat)(NF f, NU8 format, NI precision) {
	...
	frmtstr[(((NI) 0))- 0] = 37;
	{
		...
		frmtstr[(((NI) 2))- 0] = 46;
		frmtstr[(((NI) 3))- 0] = 42;
		frmtstr[(((NI) 4))- 0] = floatformattochar_98664[(format)- 0];
		frmtstr[(((NI) 5))- 0] = 0;
	...
	LA3: ;
	{
		frmtstr[(((NI) 1))- 0] = floatformattochar_98664[(format)- 0];
		frmtstr[(((NI) 2))- 0] = 0;
